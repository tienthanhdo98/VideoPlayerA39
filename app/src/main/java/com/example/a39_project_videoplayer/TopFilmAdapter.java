...
public class TopFilmAdapter extends RecyclerView.Adapter<TopFilmAdapter.ViewHolder> {

    List<VideoDescription> list;

    public TopFilmAdapter(List<VideoDescription> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_list_hoziron_type2,parent,false);
